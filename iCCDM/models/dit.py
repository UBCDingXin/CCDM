...
#     """
#     Embeds labels into vector representations. Also handles label dropout for classifier-free guidance.
#     """
...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        self.null_cond_emb = nn.Parameter(-1*torch.abs(torch.randn(cond_dim)), requires_grad=True)
    ...
    def forward(self, 
                ...
                return_bottleneck = False, #not used, for compatibility only.
        ...
        labels_emb: (N,) label embedding vecotr
        """
        ...
        y_emb = self.y_embedder(labels_emb)
