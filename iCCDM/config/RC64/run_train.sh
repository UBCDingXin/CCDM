...
python main.py \
    ...
    --use_y2cov --y2cov_hy_weight_train 1e-3 --y2cov_hy_weight_test 1e-3 --y2cov_embed_type "resnet" --net_embed_y2cov_y2emb "cnn" \
    ...
    --nfake_per_label 200 --samp_batch_size 200 \
    --dump_fake_data \
    --do_eval \
    2>&1 | tee output_${DATA_NAME}_${IMG_SIZE}_${SETTING}.txt

    # --do_eval \
    # --dump_fake_for_niqe --niqe_dump_path "<YOU_PATH>/evaluation/NIQE/RC-49/NIQE_64x64/fake_data/" \