...
python main.py \
    ...
    --model_config "./config/model_cfg/unet_ccdm_192_v1.yaml" \
    ...
    --train_num_steps 800000 --resume_step 0 --train_lr 1e-5 \
    --train_batch_size 28 --gradient_accumulate_every 4 \
    ...
    --nfake_per_label 1000 --samp_batch_size 50 --eval_batch_size 50 \
    --dump_fake_data \
    --do_eval \
    ...
    # --do_eval \
    # --dump_fake_for_niqe --niqe_dump_path "<YOU_PATH>/evaluation/NIQE/UTKFace/NIQE_192x192/fake_data/" \
