...
python main.py \
    ...
    --train_batch_size 16 --gradient_accumulate_every 2 \
    ...
    --nfake_per_label 1000 --samp_batch_size 100 --eval_batch_size 100 \
    --dump_fake_data \
    --do_eval \
    ...
    # --do_eval \
    # --dump_fake_for_niqe --niqe_dump_path "<YOU_PATH>/evaluation/NIQE/UTKFace/NIQE_256x256/fake_data/" \
