...
if __name__ == "__main__":
    ...
    netG = CcGAN_SNGAN_Generator(dim_z=256, dim_embed=128, gene_ch=64).cuda() #50303491 parameters
    netD = CcGAN_SNGAN_Discriminator(dim_embed=128, disc_ch=64).cuda() #82378113 parameters
