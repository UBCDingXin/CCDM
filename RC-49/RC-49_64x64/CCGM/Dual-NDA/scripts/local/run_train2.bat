...
set fake_data_path_1=%ROOT_PREFIX%/CCGM/CcGAN/output/CcGAN_SAGAN_soft_si0.047_ka50625.000_hinge_nDs2_nDa1_nGa1_Dbs256_Gbs256_DiAu/bad_fake_data/exp_niters30000/badfake_NIQE0.7_nfake54000.h5
