...
@REM for evaluation
set CKPT_G=./output/%GAN_NAME%/checkpoints/RC49-ADCGAN-train-2024_01_05_06_39_53/model=G-current-weights-step=20000.pth
set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/RC49-ADCGAN-train-2024_01_05_06_39_53/model=G_ema-current-weights-step=20000.pth
