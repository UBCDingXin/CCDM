...
def parse_opts():
    ...
    parser.add_argument('--attention_resolutions', type=str, default='16_32_64')
    parser.add_argument('--channel_mult', type=str, default='1_2_4_8')
    parser.add_argument('--cond_drop_prob', type=float, default=0.5)

    ''' Training '''
    ## Auxiliary net
    parser.add_argument('--net_aux', type=str, default='ResNet34') 
    parser.add_argument('--epoch_aux', type=int, default=200) 
    parser.add_argument('--resumeepoch_aux', type=int, default=0) 
    parser.add_argument('--batch_size_aux', type=int, default=256, metavar='N')
    parser.add_argument('--dim_t_emb_aux', type=int, default=256) 
    parser.add_argument('--lambda_aux', type=float, default=0)
    parser.add_argument('--aux_start_step', type=int, default=0, metavar='N') #start guiding 
    ...
    parser.add_argument('--samp_batch_size', type=int, default=50)
