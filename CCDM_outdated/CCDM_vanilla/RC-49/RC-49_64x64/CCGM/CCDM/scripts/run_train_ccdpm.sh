...
ROOT_PREFIX="<YOUR_PATH>/CCDM/RC-49/RC-49_64x64"
ROOT_PATH="${ROOT_PREFIX}/CCGM/CCDM"
DATA_PATH="<YOUR_PATH>/CCDM/datasets/CCGM_or_regression/RC-49"
...
NIQE_PATH="<YOUR_PATH>/CcGAN_TPAMI_NIQE/RC-49/NIQE_64x64/fake_data"
