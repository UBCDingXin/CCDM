...
if nda_d>0 and not args.dump_fake_for_NIQE:
    print("\r Load Bad Fake Data...")
    print("\r "+ args.path2badfake1)
    assert "NIQE" in args.path2badfake1
    hf = h5py.File(args.path2badfake1, 'r') #NIQE filtering
    ...
    if args.path2badfake3!="None":
        ...
        hf = h5py.File(args.path2badfake3, 'r') #NIQE filtering
    ...
    if nda_d_nfake>0:
        print("\r Take {} bad fake images...".format(nda_d_nfake))
...
if nda_e>0 and not args.dump_fake_for_NIQE:
    print("\r Load Bad Fake Data 2...")
    print("\r "+ args.path2badfake2)
    assert "MAE" in args.path2badfake2
    hf = h5py.File(args.path2badfake2, 'r') #MAE filtering
    ...
    if args.path2badfake4!="None":
        ...
        hf = h5py.File(args.path2badfake4, 'r') #MAE filtering
    ...
    if nda_e_nfake>0:
        print("\r Take {} bad fake images...".format(nda_e_nfake))
