...
@REM     --print_freq 500 --save_freq 2000 ^ %*


@REM @REM ===================================================================================================
set CKPT_G=./output/%GAN_NAME%/checkpoints/Cell200-ADCGAN-train-2024_01_16_13_13_44/model=G-current-weights-step=20000.pth
set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/Cell200-ADCGAN-train-2024_01_16_13_13_44/model=G_ema-current-weights-step=20000.pth
