...
set ROOT_PREFIX=D:/BaiduSyncdisk/Baidu_WD/CCGM/CcDDPM/UTKFace/UK64
...
set NIQE_PATH=C:/LocalWD/CcGAN_TPAMI_NIQE/UTKFace/NIQE_64x64/fake_data
...
python main.py ^
    ...
    --nonzero_soft_weight_threshold 1e-5 ^
