...
path_to_output = os.path.join(wd, 'output')
...
if args.comp_FID:
    ...
    eval_results_logging_fullpath = os.path.join(save_setting_folder, 'eval_results_{}_niters{}.txt'.format(args.GAN_arch, args.niters_gan))
