...
OT_PATH="<YOUR PATH>/CCDM/RC-49/RC-49_64x64/CCGM/CcGAN"
...
niqe_dump_path="<YOUR PATH>/CCDM/CcGAN_TPAMI_NIQE/RC-49/NIQE_filter_64x64/fake_data"
...
python main.py \
    ...
    --niqe_filter --samp_batch_size 500 --niqe_nfake_per_label_burnin 400 --niqe_dump_path $niqe_dump_path \