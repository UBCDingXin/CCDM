...
from utils import cycle, divisible_by, exists, hflip_images, normalize_images
            ...
            while self.step < self.train_num_steps:
                ...
                for _ in range(self.gradient_accumulate_every):
                    ...
                    if self.threshold_type=="hard" and self.kappa==0:
                        ...
                        batch_images = torch.from_numpy(normalize_images(hflip_images(self.train_images[batch_real_indx]), to_neg_one_to_one=False))
