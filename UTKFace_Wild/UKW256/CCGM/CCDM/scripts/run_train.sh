...
ROOT_PREFIX="<YOUR_PATH>/CCDM/UTKFace_Wild/UKW256"
ROOT_PATH="${ROOT_PREFIX}/CCGM/CCDM"
DATA_PATH="<YOUR_PATH>/CCDM/datasets/UTKFace"
EVAL_PATH="${ROOT_PREFIX}/evaluation/eval_models"
NIQE_PATH="<YOUR_PATH>/CcGAN_TPAMI_NIQE/UTKFace_Wild/NIQE_256x256/fake_data"
...
python main.py \
    ...
    --niters 800000 --resume_niter 0 --train_lr 1e-5 --train_timesteps 1000 \
