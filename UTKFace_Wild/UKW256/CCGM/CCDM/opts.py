...
def parse_opts():
    ...
    ''' Training '''
    ## Diffusion model
    parser.add_argument('--pred_objective', type=str, default='pred_x0') 
    ...
    parser.add_argument('--ema_update_after_step', type=int, default=100, metavar='N')
    parser.add_argument('--ema_update_every', type=int, default=10, metavar='N')
    ...
    parser.add_argument('--batch_size_embed', type=int, default=64, metavar='N')
