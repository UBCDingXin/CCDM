...
set NIQE_PATH=C:/LocalWD/CcGAN_TPAMI_NIQE/UTKFace_Wild/NIQE_filter_256x256/fake_data
...
python main.py ^
    ...
    --setting_name %SETTING% --samp_batch_size 100 ^
    --niqe_filter ^
    --niqe_dump_path %NIQE_PATH% --niqe_nfake_per_label_burnin 10000 ^ %*