...
class Dataset_(Dataset):
    ...
    def load_dataset(self):
        ...
        max_num_img_per_label_after_replica=1e30
        max_num_img_per_label=0

        ## modified for ccgan's experiment
        print("Start loading {} h5 file...".format(self.data_name))
        data_filename = self.data_dir+ '/UTKFace_Wild_{}x{}.h5'.format(img_size, img_size)
        print(data_filename)
