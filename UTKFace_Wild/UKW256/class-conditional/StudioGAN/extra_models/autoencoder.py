...
class encoder(nn.Module):
    def __init__(self, dim_bottleneck=512, ch=64):
        ...
        self.conv = nn.Sequential(
            ...
            nn.Conv2d(ch, ch*2, kernel_size=4, stride=2, padding=1), #h=h/2; 32
            nn.BatchNorm2d(ch*2),
            nn.ReLU(),
            ...
            nn.Conv2d(ch*2, ch*4, kernel_size=4, stride=2, padding=1), #h=h/2; 16
            nn.BatchNorm2d(ch*4),
            nn.ReLU(),
            ...
            nn.Conv2d(ch*4, ch*8, kernel_size=4, stride=2, padding=1), #h=h/2; 8
            nn.BatchNorm2d(ch*8),
            nn.ReLU(),
...
if __name__=="__main__":
    ...
    print('encoder:', get_parameter_number(net_encoder))
    print('decoder:', get_parameter_number(net_decoder))
