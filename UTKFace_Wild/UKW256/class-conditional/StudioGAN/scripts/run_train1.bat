...
@REM set CKPT_G=./output/%GAN_NAME%/checkpoints/UKW256-ReACGAN-train-2024_01_30_02_16_54/model=G-current-weights-step=20000.pth
@REM set CKPT_G_EMA=./output/%GAN_NAME%/checkpoints/UKW256-ReACGAN-train-2024_01_30_02_16_54/model=G_ema-current-weights-step=20000.pth
